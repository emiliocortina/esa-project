...
export class CategoriesService
{
  ...
  {
    this.addCategory('temp', 'Temperatures', '/assets/icon/hot.svg', 'assets/images/desert.jpg');
    ...
    this.addCategory('tide', 'Tides', '/assets/icon/wave.svg', 'assets/images/tides.jpg');
  }
